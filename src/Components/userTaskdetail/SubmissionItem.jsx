...
const SubmissionItem = ({ submission, onApprove, onReject }) => {
  return (
    <div className="flex justify-between items-center bg-gray-100 rounded-lg p-4">
    <div>
      <p><strong>User:</strong> {submission.user}</p>
      <p><strong>Proof:</strong> <a href={submission.proof} target="_blank" rel="noopener noreferrer" className="text-blue-500">View Proof</a></p>
      <p>
